...
const FOOTER_COLUMNS = [
  {
    ...
    links: [
      ...
      { label: 'Accumulator builder', href: '/predictions/accumulator' },
    ...
    <footer className="border-t border-border bg-surface">
      <Container className="py-14">
        ...
        <p className="mt-6 text-center text-xs leading-relaxed text-muted sm:text-left">
          Predictions are generated by a statistical model and are provided for informational and
          entertainment purposes only. They are not betting advice. Please gamble responsibly.
        </p>
      </Container>
    </footer>
  );
